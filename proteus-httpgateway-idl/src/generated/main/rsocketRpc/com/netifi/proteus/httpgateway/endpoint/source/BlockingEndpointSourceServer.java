...
@javax.inject.Named(
    value ="BlockingEndpointSourceServer")
public final class BlockingEndpointSourceServer extends io.rsocket.rpc.AbstractRSocketService {
  ...
  @javax.inject.Inject
  public BlockingEndpointSourceServer(BlockingEndpointSource service, java.util.Optional<reactor.core.scheduler.Scheduler> scheduler, java.util.Optional<io.micrometer.core.instrument.MeterRegistry> registry) {
    ...
    if (!registry.isPresent()) {
      ...
      this.streamProtoDescriptors = io.rsocket.rpc.metrics.Metrics.timed(registry.get(), "rsocket.server", "service", BlockingEndpointSource.SERVICE_ID, "method", BlockingEndpointSource.METHOD_STREAM_PROTO_DESCRIPTORS);
    }
  ...
  public String getService() {
    return BlockingEndpointSource.SERVICE_ID;
  }
  ...
  public reactor.core.publisher.Flux<io.rsocket.Payload> requestStream(io.rsocket.Payload payload) {
    try {
      ...
      switch(io.rsocket.rpc.frames.Metadata.getMethod(metadata)) {
        case BlockingEndpointSource.METHOD_STREAM_PROTO_DESCRIPTORS: {
          com.google.protobuf.CodedInputStream is = com.google.protobuf.CodedInputStream.newInstance(payload.getData());
          com.google.protobuf.Empty message = com.google.protobuf.Empty.parseFrom(is);
          return reactor.core.publisher.Flux.defer(() -> reactor.core.publisher.Flux.fromIterable(service.streamProtoDescriptors(message, metadata)).map(serializer).transform(streamProtoDescriptors)).subscribeOn(scheduler);
        }
        default: {
